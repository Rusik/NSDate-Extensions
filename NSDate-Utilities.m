...
+ (NSComparisonResult)compareDayInDate:(NSDate *)date1 withDayInDate:(NSDate *)date2 {
    int day1 = date1.dayOfYear;
    int day2 = date2.dayOfYear;
    int year1 = date1.year;
    int year2 = date2.year;

    if (year1 == year2) {
        if (day1 == day2) {
            return NSOrderedSame;       //date1 = date2
        } else if (day1 > day2) {
            return NSOrderedDescending; //date1 > date2
        } else {
            return NSOrderedAscending;  //date1 < date2
        }
    } else if (year1 > year2) {
        return NSOrderedDescending;     //date1 > date2
    } else {
